...
namespace iSpa
{
    public partial class EditPass : Form
    {
        ...
        private String _Title = "Réinitialiser mot de passe";
        private String _Username;
        private String[] _Headers = new String[3] { "Ancien mot de passe", "Nouveau mot de passe", "Répéter nouveau mot de passe" };
        private int _SizeTable;
        private List<TextBox> _Inputs;
        private ArrayList _ArrayParam;


        public EditPass(String xUsername)
        {
            InitializeComponent();
            _Username = xUsername;
